...
class B2_VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.conv1(x)
        x = self.conv2(x)
        conv_3_3 = self.conv3(x)
        conv_4_3 = self.conv4_1(conv_3_3)
        conv_5_3 = self.conv5_1(conv_4_3)
        conv_6_3 = self.conv5_2(conv_5_3)
        return conv_3_3,conv_4_3,conv_5_3,conv_6_3
